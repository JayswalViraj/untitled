...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String baseUrl = 'https://demo33333.herokuapp.com'
  ...
  Future<void> getToken() async {
    final response = await http.get(
      Uri.parse(baseUrl + '/access_token?channel=${_channelName.toString()}&/' + _channelName.toString()+ '/publisher/uid/' + uid.toString()
        // To add expiry time uncomment the below given line with the time in seconds
        // + '?expiry=45'
      )//('/test?id=12&name=wendu');
    );
